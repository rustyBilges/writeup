...
\section{Persistence without immigration?}

\section{Why are some networks more stable than others?}

Chapter on ecosystem stability, with focus on this model? (Stability is implicitly involved in all the work up to this point, so does not constitute a separate chapter?)

Or chapter on inferring species interaction strengths from time series.
...
%\input{/home/rusty/Documents/phd files/habitat_loss_project/writings/chapter_2/chapter_2_content}
