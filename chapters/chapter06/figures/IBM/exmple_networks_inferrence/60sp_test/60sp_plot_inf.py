...
NEW = False  ## otherwise original

#jhat = np.genfromtxt("average_jaht_highIR_60sp_mut0.csv", delimiter=',') #  zeros((5,5))
#jhat = np.genfromtxt("average_jaht_ORIG_60sp_mut0.csv", delimiter=',') #  zeros((5,5))
if NEW:
	jhat = np.genfromtxt("average_jaht_NEW_60sp_mut0.csv", delimiter=',') #  zeros((5,5))
else:
	jhat = np.genfromtxt("average_jaht_ORIG_60sp_mut0.csv", delimiter=',') #  zeros((5,5))
Nsp = 4
print jhat
...
plt.axis('off')
#plt.savefig("60species_orig_mut0_average_Jhat.png")
if NEW:
	plt.savefig("60species_new_mut0_average_Jhat.png")
else:
	plt.savefig("60species_orig_mut0_average_Jhat.png")
plt.show()
